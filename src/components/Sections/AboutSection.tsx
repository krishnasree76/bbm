        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 h-full">
              ...
              {/* Card 1 */}
              <div className="glass p-6 rounded-2xl bg-[#111] border border-gray-800 flex flex-col items-center justify-center text-center hover:bg-[#151515] transition-colors">
