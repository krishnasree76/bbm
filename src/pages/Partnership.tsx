...
const Partnership = () => {
    const [isDealership, setIsDealership] = useState<boolean>(true);
        ...
        <div className="min-h-screen bg-[#0B0B0B] text-white pt-28 pb-12 px-6">
            <div className="max-w-3xl mx-auto bg-[#111] p-8 rounded-2xl border border-gray-800 shadow-2xl">
                ...
                >
                    ...
                    {isDealership ? (
                        <>
                            <input
                                type="text"
                                name="targetPlace"
                                placeholder="Place of Dealership"
                                onChange={handleChange}
                                required
                                className="input-style"
                            />
                        ...
                        <>
                            <input
                                type="text"
                                name="idProof"
                                placeholder="ID Proof (Aadhar/License)"
                                onChange={handleChange}
                                required
                                className="input-style"
                            />
                    ...
                    <button
                        type="submit"
                        className="col-span-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-lg transition-colors mt-4"
                    >
                        Submit to WhatsApp
                    </button>
                </form>
            ...
            {/* Tailwind alternative (recommended instead of style jsx) */}
            <style>{`
        .input-style {
          background: #1a1a1a;
